...
<!-- EMPIEZA LA PAG -->
                            <br><br>
<center>
<p> ESTA CONSULTA PUEDE SER POR;<br>FECHA DE INICIACION DEL TRABAJO </p>

<form action="consultadiaria1.php" method="post" name="form1" id="form1" enctype="multipart/form-data">
...
<tr>
  <td width="80"><strong>Criterio de Búsqueda</strong></td>
   ...
   date_default_timezone_set('America/Caracas');
        ...
        $set=date("d/m/Y");     
            ?>
  <td><input type="text" id="fecha1" name="fecha" size="10" onkeypress="return nonumeyletra(event)"readonly="readonly" value="<?php  echo "$set";
            ?>"/>
          <input type="image" src="calendario/calendario.gif" id="fecha" />
          <input type="hidden" name="fechatemp1" id="fechatemp" size="20" value="<?php  echo "$set";
            ?>" />
