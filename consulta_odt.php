...
<?php
	...
	$consulta="SELECT * FROM odt order by fecha_ini LIMIT $desde, $hasta";
...
<p></strong></CAPTION>
  ...
  <TR>
	...
	<TH bgcolor="#E4E4E7">Fecha de Inicio</TH>
	<TH bgcolor="#E4E4E7">Fecha de Final</TH>
	<TH bgcolor="#E4E4E7" >Fallos</TH>
  </tr>
    ...
    <?PHP
		...
		$consulta="select count(id_odt) from odt";
...

		{
			...
			echo "<a href=\"consulta_odt.php?pag=1\">|<<</a> <a href=\"pagina1.php?pag=".($pag-1)."\"></a> | ";

		}

		echo "<a href=\"consulta_odt.php\">Volver</a> | ";
...

		{
			...
			echo "<a href=\"consulta_odt.php?pag=".($pag+1)."\">>></a> <a href=\"pagina1.php?pag=".($paginas)."\">|</a>";
