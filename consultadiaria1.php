...
// consulta a la tabla informe_personal	
	$consulta="SELECT * FROM odt where fecha_ini='$fecha'";
   ...
   <TR bgcolor="#E4E4E7">
	...
	<?PHP
		...
		$nro_fil = mysql_num_rows($resultado);
                   ...
                   echo "<center><strong><center>En esta fecha no hay equipos en reparacion <br> por favor valide sus datos.</center></strong></center><br>";
                   }else
